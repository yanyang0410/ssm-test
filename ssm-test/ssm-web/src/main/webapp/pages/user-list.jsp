            ...
            <div class="box box-primary">
                            ...
                            <c:forEach items="${pageInfo.list}" var="user">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/users/findById.do?id=${user.id}"
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/users/findAll.do?page=1&size=${pageInfo.pageSize}"
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/users/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}"
...
<script>
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "${pageContext.request.contextPath}/users/findAll.do?page=1&pageSize="
            + pageSize;
    }
